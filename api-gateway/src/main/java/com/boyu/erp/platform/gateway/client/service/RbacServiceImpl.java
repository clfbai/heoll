package com.boyu.erp.platform.gateway.client.service;//package com.open.capacity.client.service;
///**
// * 
// */
//
...
//                    return false;
//                } else {
//                    List<Map> listgoods = serviceDao.listByClientId(Long.valueOf(String.valueOf(map.get("id"))));
//                    ;
//
//                    for (Iterator<Map> it = listgoods.iterator(); it.hasNext(); ) {
//                        Map temp = it.next();
//
